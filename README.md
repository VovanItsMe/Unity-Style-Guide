...
(Содержит объекты для геймплея)
				Items (Содержит игровые предметы)
					Flashlight
				Maps (Содержит оптимизированные и финализированные составные элементы отдельных карт)
					City
			General
				Animations (Содержит общие анимационные клипы с анимационными контроллерами)
